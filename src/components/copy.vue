...
<!--      <div class="panel-top" @click.stop></div>-->
...
.overlay {
  ...
  inset: 0;
  z-index: 2000;
  pointer-events: auto; /* block clicks to page while overlay open */
  --mask-top: 56px; /* navbar height */
}
...
.panel-top {
  ...
  height: var(--mask-top);
  background: transparent; /* keep navbar visible visually */
  pointer-events: auto; /* intercept clicks so navbar is not clickable */
}
